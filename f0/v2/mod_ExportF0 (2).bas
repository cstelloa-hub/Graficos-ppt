...
Sub ExportarDataF0()
    ...
    cf = Array(Array("Fondo", "Fondo 0"), _
               ...
               Array("Carpeta de salida", carpetaSal), _
               ...
               Array("Criterio universo: dias max al vcto (corp y depositos)", DIAS_MAX_CORP), _
               Array("Criterio universo: soberanos sin tope de plazo", SOB_TODO_PLAZO), _
    ...
    MsgBox "Listo: " & destino & vbCrLf & vbCrLf & _
           ...
           "Benchmark F0: " & IIf(Len(bmk) > 0, bmk & " (heredado)", "vacio, cargar en Config") & vbCrLf & _
